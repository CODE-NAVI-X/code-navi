...
| 分组 | 条目（路由） | 说明 |
| --- | --- | --- |
| 学习闭环 | 理解学习 (`/learning`)、动手实践 (`/learning/practice`)、**项目代码 (`/learning/projects`，新增入口)**、知识复盘 (`/learning/portrait`)、学习笔记 (`/learning/notebook`) | 核心闭环，一级分组 |
