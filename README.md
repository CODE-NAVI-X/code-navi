...
- 初稿只允许用户主动粘贴 Markdown/纯文本并保存在当前本地会话；结构化审稿、修订任务和投稿前检查均是建议，不是导师结论、同行评审结论或投稿资格判断。投稿前检查只读取本地已保存工件，不联网；它会提示匿名、伦理、引用、材料和 venue 格式的待确认项。逐段候选改写只针对用户已接受任务；原文、候选、依据和事实边界都会展示，只有用户再次接受或手动编辑后才创建新版本，原稿和历史版本始终保留。
