...
def bash_spec() -> ToolSpec:
    return ToolSpec(
        ...
        required_permissions=frozenset({ToolPermission.DESTRUCTIVE, ToolPermission.EXECUTE}),
    )
...
def bash_handler(args: Mapping[str, Any], context: ToolExecutionContext) -> dict[str, Any]:
