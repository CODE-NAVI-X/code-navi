...
class ReplayDivergence(FatalProviderError):
    ...
    def __init__(
        ...
        *,
        ...
        self.actual = actual
        self.expected_request = None if expected_request is None else dict(expected_request)
...
def first_structural_difference(
    ...
    if isinstance(expected, Mapping):
        ...
        for key in expected:
            ...
            difference = first_structural_difference(expected[key], actual[key], child_path)
